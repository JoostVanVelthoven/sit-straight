...
export const isCorrectPosition$ = new BehaviorSubject(undefined);
export const time$ = interval(1000).pipe(
    withLatestFrom(isCorrectPosition$),
    filter(([_, isCorrectPosition]) => isCorrectPosition !== undefined),
...
export const timeCorrect$ = timeCorrectCounter$.pipe(
    map(seconds => secondsToHuman(seconds)));
